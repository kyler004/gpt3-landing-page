...
const Footer = () => (
  <div className="flex flex-col justify-center items-center bg-gray-800 section__padding fade-in">
    ...
    <div className="flex justify-center items-center py-4 px-8 border border-white text-center mb-40 cursor-pointer bg-linear-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 rounded-lg shadow-lg transition-all duration-300">
